...
public class TestCases {
	...
	public static void priorityScheduling() {
		...
		SystemInterface.send(ha, new Message(true, "em	", name, 2));
		SystemInterface.send(ha, new Message(true, "gee", name, 3));
		SystemInterface.send(ha, new Message(true, "oh", name, 1));
	}
